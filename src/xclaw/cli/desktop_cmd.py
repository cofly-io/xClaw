# -*- coding: utf-8 -*-
"""CLI command: run xClaw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run xClaw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing xClaw app instance.
    """
    ...
    click.echo(f"Starting xClaw app on {url} (port {port})")
