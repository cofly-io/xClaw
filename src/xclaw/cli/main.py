...
@click.group(
    ...
    lazy_subcommands={
        "app": ("xclaw.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "xclaw.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("xclaw.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("xclaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("xclaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("xclaw.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("xclaw.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("xclaw.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("xclaw.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "xclaw.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("xclaw.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "xclaw.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("xclaw.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("xclaw.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "xclaw.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("xclaw.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("xclaw.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("xclaw.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "xclaw.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("xclaw.cli.task_cmd", "task_cmd", ".task_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="xClaw")
