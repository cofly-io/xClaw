...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs xClaw (e.g. "
...
async def browser_use(  # pylint: disable=R0911,R0912
    ...
    Args:
        ...
        cdp_port (int):
            ...
            xClaw chooses a free local port automatically for managed CDP.
        private_mode (bool):
            ...
            via CDP. Default False. By default, xClaw prefers managed CDP for
