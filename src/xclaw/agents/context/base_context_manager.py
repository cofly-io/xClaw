...
def _load_context_manager_implementations() -> None:
    """Import concrete backends so ``@context_registry.register`` runs."""
    from . import light_context_manager as _light_cm  # noqa: F401 pylint: disable=unused-import


_load_context_manager_implementations()
