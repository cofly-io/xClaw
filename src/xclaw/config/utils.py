...
def get_available_channels() -> Tuple[str, ...]:
    ...
    xclaw.channels), filtered by QWENPAW_ENABLED_CHANNELS or
...
def is_xclaw_running() -> bool:
    """Check if xClaw is currently running by checking API availability.

    Returns:
        True if xClaw is running, False otherwise
    """
    try:
