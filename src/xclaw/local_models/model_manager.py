...
class ModelManager:
    ...
    def get_recommended_models(self) -> list[LocalModelInfo]:
        ...
        if memory_gb <= 8:
            models = [
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-2B-Q4_K_M",
                    name="xClaw-Flash-2B-Q4_K_M",
                    size_bytes=1560460768,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-2B-Q8_0",
                    name="xClaw-Flash-2B-Q8_0",
            ...
            models = [
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-4B-Q4_K_M",
                    name="xClaw-Flash-4B-Q4_K_M",
                    size_bytes=3066384736,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-4B-Q8_0",
                    name="xClaw-Flash-4B-Q8_0",
            ...
            models = [
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-9B-Q4_K_M",
                    name="xClaw-Flash-9B-Q4_K_M",
                    size_bytes=5476080128,
                    source=DownloadSource.MODELSCOPE,
                ),
                LocalModelInfo(
                    id="AgentScope/xClaw-Flash-9B-Q8_0",
                    name="xClaw-Flash-9B-Q8_0",
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"xclaw-model-download-{task_id}",
            command=[
                "xclaw-model-download",
                repo_id,
