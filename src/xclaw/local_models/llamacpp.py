...
from xclaw.constant import DEFAULT_LOCAL_PROVIDER_DIR
...
class LlamaCppBackend:
    """
    xClaw local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"xclaw-llamacpp-download-{staging_dir.name}",
            command=["xclaw-llamacpp-download", download_url],
