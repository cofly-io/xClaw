...
function SkillsPage() {
  ...
  const [hoverSkillName, setHoverSkillName] = useState<string | null>(null);
  const {
    skills,
    visibleSkills,
    hasMore,
    ...
    <div className={styles.skillsPage}>
      ...
      {loading ? (
        ...
        <div className={styles.noSearchResults}>
          <span className={styles.noSearchResultsIcon}>馃攳</span>
        ...
        <div className={styles.skillsGrid}>
          {visibleSkills.map((skill) => (
            <SkillCard
              key={skill.name}
              skill={skill}
              isHover={hoverSkillName === skill.name}
              selected={
                batchModeEnabled ? selectedSkills.has(skill.name) : undefined
              }
              onSelect={() => toggleSelect(skill.name)}
              onClick={() => handleEdit(skill)}
              onMouseEnter={() => setHoverSkillName(skill.name)}
              onMouseLeave={() => setHoverSkillName(null)}
