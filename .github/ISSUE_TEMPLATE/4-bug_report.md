...
[Provide the version of xClaw you are using, e.g. 0.x.x or git commit hash.]
[Using `xclaw --version` in your command line or checking the version in the console UI can help.]
...
- **xClaw version:** [e.g. 0.x.x or git commit]
