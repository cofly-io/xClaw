...
Welcome to the xClaw community! Whether you want to report bugs, seek help, share experiences, or contribute to development, you can reach us through the following channels.

---

## 💬 User Community

For all xClaw users: questions, discussions, feature suggestions, and more.
...
- **Share experiences** - Your xClaw use cases and tips
...
For contributors focused on development: if you have submitted a PR, claimed a feature, or would like to contribute to xClaw development, you are welcome to join the following developer channels (mainly for development collaboration and technical discussions).
...
- **DingTalk Developer Group**: This group is application-based. In your join request note, include one of the following: a PR you submitted (for example: PR#1221), a feature you have claimed (for example: Claim Issue#133), or the xClaw development area you want to help with (for example: xClaw frontend, unit tests). Your request will not be approved if none of these is provided.

- **Discord (Developers)**: Please first post one of the three items above in the xClaw Discord community. After admin confirmation, you will be invited to the private developer channel.
...
### [GitHub Discussions](https://github.com/agentscope-ai/xClaw/discussions)
...
### [GitHub Issues](https://github.com/agentscope-ai/xClaw/issues)
...
- **GitHub**: [agentscope-ai/xClaw](https://github.com/agentscope-ai/xClaw) - Star the project for update notifications
