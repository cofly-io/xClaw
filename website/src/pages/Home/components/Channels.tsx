    ...
    >
      ...
      <motion.div className="relative mt-12 w-full" variants={itemVariants}>
        <div className="group/row-top overflow-hidden">
          <div className="inline-flex w-max items-center gap-3 whitespace-nowrap py-1 will-change-transform animate-[xclaw-channels-marquee-right_72s_linear_infinite] group-hover/row-top:[animation-play-state:paused]">
        ...
        <div className="group/row-bottom mt-3 overflow-hidden">
          <div className="inline-flex w-max items-center gap-3 whitespace-nowrap py-2 will-change-transform animate-[xclaw-channels-marquee-left_72s_linear_infinite] group-hover/row-bottom:[animation-play-state:paused]">
            {[...TOP_CHANNELS, ...TOP_CHANNELS].map((item, idx) => (
              <ChannelPill
