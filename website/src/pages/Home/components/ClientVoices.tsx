...
const AVATARS = [
  {
    key: "a1",
    src: AVATAR_URLS.a1,
    alt: "xClaw user avatar 1",
  },
  {
    key: "a2",
    src: AVATAR_URLS.a2,
    alt: "xClaw user avatar 2",
  },
  {
    key: "a3",
    src: AVATAR_URLS.a3,
    alt: "xClaw user avatar 3",
  },
  {
    key: "a4",
    src: AVATAR_URLS.a4,
    alt: "xClaw user avatar 4",
  },
  {
    key: "a5",
    src: AVATAR_URLS.a5,
    alt: "xClaw user avatar 5",
  },
] as const;
...
export function ClientVoices() {
  ...
  return (
    <motion.section
      ...
      aria-labelledby="xclaw-client-voices-heading"
    >
      <div className="mx-auto max-w-7xl">
        <motion.div variants={itemVariants}>
          ...
          <h2
            id="xclaw-client-voices-heading"
