  ...
  return (
    <>
      <motion.section
        ...
        aria-labelledby="xclaw-works-heading"
      >
        <div className="mx-auto max-w-7xl">
          <motion.div variants={item}>
            <h2
              id="xclaw-works-heading"
          ...
          <div className="relative mt-8 py-8 md:mt-12 md:py-12">
            ...
            <div
              className="pointer-events-none absolute bottom-0 left-1/2 h-px w-screen -translate-x-1/2 animate-[xclaw-dash-move-left_1s_linear_infinite]"
              style={{
                background:
                  "repeating-linear-gradient(to right, rgba(255,157,77,0.45) 0 8px, transparent 8px 16px)",
                backgroundSize: "16px 100%",
