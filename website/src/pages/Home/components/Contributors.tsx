  ...
  return (
    <>
      <motion.section
        ...
        aria-labelledby="xclaw-contributors-heading"
      >
        <div className="mx-auto max-w-7xl text-center">
          <motion.h2
            id="xclaw-contributors-heading"
          ...
          <div
            className="pointer-events-none relative left-1/2 mt-10 h-px w-screen -translate-x-1/2 animate-[xclaw-dash-move-right_1s_linear_infinite]"
            style={{
              background:
          ...
          >
            ...
            <p>
              ...
              <a
                href="https://github.com/agentscope-ai/xClaw"
                target="_blank"
                rel="noopener noreferrer"
                className="text-(--color-primary) ml-1"
              >
