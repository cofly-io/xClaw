...
欢迎加入 xClaw 社区！无论你是想报告 Bug、寻求帮助、分享使用经验，还是参与开发，都可以通过以下渠道与我们联系。

---

## 💬 用户社区

适合所有 xClaw 用户：问题咨询、使用交流、功能建议等。
...
面向参与开发的贡献者：如果你提交过 PR、认领了功能开发，或希望参与 xClaw 开发，欢迎加入开发者交流渠道（主要用于开发协作与技术讨论）。
...
- **钉钉开发者群**：该群为申请制，请在加群备注中写明你提交过的 PR（例如：PR#1221）、已认领的功能（例如：认领 Issue#133），或你期望参与的 xClaw 开发功能项（例如：希望参与 xClaw 前端、单测等）。备注中必须包含以上三项信息之一，否则入群申请将不予通过。

- **Discord（开发者）**：请先在 xClaw Discord 社区中发送上述三项信息之一，管理员确认后会邀请你进入 private 开发者 channel。
...
- **GitHub**: [agentscope-ai/xClaw](https://github.com/agentscope-ai/xClaw) - Star 项目获取最新更新通知
