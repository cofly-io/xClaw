...
from xclaw.exceptions import ChannelError
from xclaw.app.channels.qq.channel import (
    QQApiError,
    QQChannel,
    _as_bool,
    _get_next_msg_seq,
...
class TestSendImages:
    ...
    @patch(
        "xclaw.app.channels.qq.channel._upload_media_async",
        new_callable=AsyncMock,
    )
    @patch(
        "xclaw.app.channels.qq.channel._send_media_message_async",
        new_callable=AsyncMock,
    )
...
class TestSendMessageAsync:
    @patch(
        "xclaw.app.channels.qq.channel._api_request_async",
        new_callable=AsyncMock,
    )
