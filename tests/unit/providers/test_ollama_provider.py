...
from xclaw.providers.ollama_provider import OllamaProvider
...
def test_client_uses_single_v1_suffix(monkeypatch, base_url: str) -> None:
    ...
    monkeypatch.setattr(
        "xclaw.providers.ollama_provider.AsyncOpenAI",
        FakeAsyncOpenAI,
    )
...
def test_get_chat_model_instance_uses_single_v1_suffix(
    ...
    monkeypatch.setattr(
        "xclaw.providers.openai_chat_model_compat.OpenAIChatModelCompat",
