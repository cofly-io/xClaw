#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for xClaw."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in xclaw package."""
...
def main():
    """Run tracer on xclaw app import."""
    ...
    tracer = ExecTracer(package_names=["xclaw"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import xclaw app to trigger startup
        from xclaw.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
