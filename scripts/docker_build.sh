...
# Example: bash scripts/docker_build.sh xclaw:latest
#          bash scripts/docker_build.sh myreg/xclaw:v1 --no-cache
#
...
echo "[docker_build] xClaw app port: 8088 (default). Override with -e QWENPAW_PORT=<port>."
